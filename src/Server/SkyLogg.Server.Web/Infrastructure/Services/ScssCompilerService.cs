...
namespace SkyLogg.Server.Web.Infrastructure.Services;
...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/SkyLogg.Client.Core");
        ...
        // but uses ../../Client/SkyLogg.Client.Web:../../Client/SkyLogg.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/SkyLogg.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/SkyLogg.Client.Maui/Components:../../Client/SkyLogg.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/SkyLogg.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/SkyLogg.Client.Windows/Components:../../Client/SkyLogg.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/SkyLogg.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/SkyLogg.Client.Web/Components:../../Client/SkyLogg.Client.Web/Components");

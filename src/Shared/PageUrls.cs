...
public static partial class PageUrls
{
    ...
    public const string AddOrEditFlightLog = "/logbook/flights/add-edit";

    public const string FlightLogDetail = "/logbook/flights/detail";

    public const string FlightSummary = "/logbook/summary";

    public const string FlightReports = "/logbook/reports";

...
### Entity (Model)
- **Location**: `src/Server/SkyLogg.Server.Api/Features/{FeatureName}/`
- **File**: `{EntityName}.cs`
- **Requirements**:
...
- **Migration**: 
  - Run: `dotnet ef migrations add {MigrationName} --output-dir Infrastructure/Data/Migrations --verbose` in `SkyLogg.Server.Api` project

### DTO
- **Location**: `src/Shared/SkyLogg.Shared/Features/{FeatureName}/`
...
**Location**: `src/Client/SkyLogg.Client.Core/Components/Pages/{FeatureName}/`

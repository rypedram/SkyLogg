...
#### Server API Resources (`src/Server/SkyLogg.Server.Api/Features/Identity/Resources/`)
...
The `AppDataAnnotationsValidator` (located in `src/Client/SkyLogg.Client.Core/Components/AppDataAnnotationsValidator.cs`) extends the validation system to:
...
Here's an actual example from the project (`src/Client/SkyLogg.Client.Core/Components/Pages/Categories/AddOrEditCategoryModal.razor`):
...
- Components: `src/Client/SkyLogg.Client.Core/Components/AppComponentBase.cs`
- Pages: `src/Client/SkyLogg.Client.Core/Components/Pages/AppPageBase.cs`
...
**Base class location**: `src/Server/SkyLogg.Server.Api/Infrastructure/Controllers/AppControllerBase.cs`

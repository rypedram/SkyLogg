...
Welcome to the interactive Getting Started guide! This document will walk you through the Entity Framework Core architecture in this SkyLogg project.
...
[`/src/Server/SkyLogg.Server.Api/Infrastructure/Data/AppDbContext.cs`](/src/Server/SkyLogg.Server.Api/Infrastructure/Data/AppDbContext.cs)
...
[`/src/Server/SkyLogg.Server.Api/Features/`](/src/Server/SkyLogg.Server.Api/Features/)
...
**File:** [`/src/Server/SkyLogg.Server.Api/Features/Categories/Category.cs`](/src/Server/SkyLogg.Server.Api/Features/Categories/Category.cs)

```csharp
using SkyLogg.Server.Api.Features.Products;

namespace SkyLogg.Server.Api.Features.Categories;
...
**File:** [`/src/Server/SkyLogg.Server.Api/Features/Categories/CategoryConfiguration.cs`](/src/Server/SkyLogg.Server.Api/Features/Categories/CategoryConfiguration.cs)

```csharp
using SkyLogg.Server.Api.Features.Categories;
...
**File:** [`/src/Server/SkyLogg.Server.Api/Program.cs`](/src/Server/SkyLogg.Server.Api/Program.cs)
```csharp
...
1. [`/src/Server/SkyLogg.Server.Api/Program.cs`](/src/Server/SkyLogg.Server.Api/Program.cs)
2. [`/src/Server/SkyLogg.Server.Web/Program.cs`](/src/Server/SkyLogg.Server.Web/Program.cs)
...
Open a terminal in the `SkyLogg.Server.Api` project directory and run:
...
**DbContext Location:** [`/src/Client/SkyLogg.Client.Core/Infrastructure/Data/AppOfflineDbContext.cs`](/src/Client/SkyLogg.Client.Core/Infrastructure/Data/AppOfflineDbContext.cs)
...
**File:** [`/src/Client/SkyLogg.Client.Core/Infrastructure/Extensions/IClientCoreServiceCollectionExtensions.cs`](/src/Client/SkyLogg.Client.Core/Infrastructure/Extensions/IClientCoreServiceCollectionExtensions.cs)
```csharp
...
1. Set `SkyLogg.Server.Web` as the **Startup Project**
2. Set `SkyLogg.Client.Core` as the **Default Project** in Package Manager Console
3. Run:
```powershell
...
Open a terminal in the `SkyLogg.Server.Web` project directory and run:
```bash
dotnet tool restore
dotnet ef migrations add YourMigrationName --context AppOfflineDbContext --output-dir Infrastructure/Data/Migrations --project ../Client/SkyLogg.Client.Core/SkyLogg.Client.Core.csproj --verbose
```
...
- Entity must inherit from `BaseEntityTableData` Example: [`/src/Server/SkyLogg.Server.Api/Features/Todo/TodoItem.cs`](/src/Server/SkyLogg.Server.Api/Features/Todo/TodoItem.cs)
- DTO must inherit from `BaseDtoTableData` Example: [`/src/Shared/Dtos/Todo/TodoItemDto.cs`](/src/Shared/Dtos/Todo/TodoItemDto.cs)
- TableController: A controller inheriting from `TableController` Example: [`/src/Server/SkyLogg.Server.Api/Features/Todo/TodoItemTableController.cs`](/src/Server/SkyLogg.Server.Api/Features/Todo/TodoItemTableController.cs)
- Repository: A repository inheriting from `EntityTableRepository` Example: [`/src/Server/SkyLogg.Server.Api/Features/Todo/TodoItemTableController.cs`](/src/Server/SkyLogg.Server.Api/Features/Todo/TodoItemTableController.cs)
...
**See:** [`/src/Client/SkyLogg.Client.Core/Infrastructure/Data/README.md`](/src/Client/SkyLogg.Client.Core/Infrastructure/Data/README.md)

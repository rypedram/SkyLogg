...
The test project is located at [`src/Tests/SkyLogg.Tests.csproj`](/src/Tests/SkyLogg.Tests.csproj) and contains:
...
<RunSettings>
    <RunConfiguration>
        <EnvironmentVariables>            
            ...
            <ConnectionStrings__sqlite>Data Source=SkyLoggDb.db;Mode=Memory;Cache=Shared;</ConnectionStrings__sqlite>
        </EnvironmentVariables>
    </RunConfiguration>
</RunSettings>
```
...
```yaml
- name: Run Tests
  run: dotnet test src/Tests/SkyLogg.Tests.csproj --configuration Release

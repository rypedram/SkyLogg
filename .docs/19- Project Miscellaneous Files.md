...
**Location**: [`/SkyLogg.sln`](/SkyLogg.sln)

**Purpose**: The **full solution file** for Visual Studio that includes ALL projects in the workspace.

**Contains**:
- Server projects (`SkyLogg.Server.Web`, `SkyLogg.Server.Api`, `SkyLogg.Server.Shared`, `SkyLogg.Server.AppHost`)
- Client projects (`SkyLogg.Client.Core`, `SkyLogg.Client.Web`, `SkyLogg.Client.Maui`, `SkyLogg.Client.Windows`)
- Shared project (`SkyLogg.Shared`)
- Tests project (`SkyLogg.Tests`)
...
### 2.2 `SkyLogg.Web.slnf`

**Location**: [`/SkyLogg.Web.slnf`](/SkyLogg.Web.slnf)
...
- `SkyLogg.Server.Web`
- `SkyLogg.Server.Api`
- `SkyLogg.Server.Shared`
- `SkyLogg.Server.AppHost`
- `SkyLogg.Client.Core`
- `SkyLogg.Client.Web`
- `SkyLogg.Shared`
- `SkyLogg.Tests`
...
**Location**: [`/SkyLogg.slnx`](/SkyLogg.slnx)
...
<Using Include="SkyLogg.Shared.Dtos" />
<Using Include="SkyLogg.Shared.Exceptions" />
<!-- ... and many more -->
```
...
```json
{
    ...
    "dotnet.defaultSolution": "SkyLogg.Web.slnf",
...
- **Default Solution**: Uses `SkyLogg.Web.slnf` for faster load times
...
- **`build`**: Builds the `SkyLogg.Server.Web` project
...
```json
{
    "configurations": [
        {
            "name": "C#: SkyLogg.Server.Web Debug",
            "type": "dotnet",
            "request": "launch",
            "projectPath": "${workspaceFolder}/src/Server/SkyLogg.Server.Web/SkyLogg.Server.Web.csproj"
        },
        {
            "name": "C#: SkyLogg.Server.Api Debug",
            "type": "dotnet",
            "request": "launch",
            "projectPath": "${workspaceFolder}/src/Server/SkyLogg.Server.Api/SkyLogg.Server.Api.csproj"
        },
        {
            "name": ".NET MAUI",
            "type": "maui",
...
- **Custom SkyLogg patterns**:
  - `*Resource.designer.cs` (auto-generated from `.resx`)
  - `/src/Client/SkyLogg.Client.Core/Scripts/*.js` (generated from TypeScript)
  - `/src/Client/SkyLogg.Client.Maui/Platforms/Android/google-services.json` (sensitive Firebase config)

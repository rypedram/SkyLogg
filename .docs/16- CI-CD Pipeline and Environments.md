...
✓ Builds entire solution (SkyLogg.slnx)
...
2. **Build & Package with Velopack**
   ...
   dotnet vpk pack \
     ...
     -e SkyLogg.Client.Windows.exe \  # Main executable
     -r win-x86 \                   # Runtime
...
1. **Setup Android Signing**
   ...
   - Save as SkyLogg.keystore in project directory
...
dotnet publish -c Release \
  ...
  -p:AndroidSigningKeyStore="SkyLogg.keystore" \
  -p:AndroidSigningKeyAlias=SkyLogg \

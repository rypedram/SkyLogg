...
Welcome to **Stage 13** of the SkyLogg project getting started guide! In this stage, we'll explore the **Force Update System** - a critical feature that ensures all users are running compatible versions of your application.
...
**File**: [`src/Client/SkyLogg.Client.Core/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs`](/src/Client/SkyLogg.Client.Core/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs)
...
**File**: [`src/Client/SkyLogg.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs`](/src/Client/SkyLogg.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs)
...
**File**: [`src/Server/SkyLogg.Server.Api/RequestPipeline/ForceUpdateMiddleware.cs`](/src/Server/SkyLogg.Server.Api/RequestPipeline/ForceUpdateMiddleware.cs)
...
**File**: [`src/Server/SkyLogg.Server.Api/appsettings.json`](/src/Server/SkyLogg.Server.Api/appsettings.json)
...
**File**: [`src/Server/SkyLogg.Server.Api/ServerApiSettings.cs`](/src/Server/SkyLogg.Server.Api/ServerApiSettings.cs)
...
**File**: [`src/Client/SkyLogg.Client.Core/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs`](/src/Client/SkyLogg.Client.Core/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs)
...
**File**: [`src/Client/SkyLogg.Client.Core/Services/Contracts/IAppUpdateService.cs`](/src/Client/SkyLogg.Client.Core/Services/Contracts/IAppUpdateService.cs)
...
**File**: [`src/Client/SkyLogg.Client.Web/Infrastructure/Services/WebAppUpdateService.cs`](/src/Client/SkyLogg.Client.Web/Infrastructure/Services/WebAppUpdateService.cs)
...
**File**: [`src/Client/SkyLogg.Client.Windows/Services/WindowsAppUpdateService.cs`](/src/Client/SkyLogg.Client.Windows/Services/WindowsAppUpdateService.cs)
...
**File**: [`src/Client/SkyLogg.Client.Maui/Services/MauiAppUpdateService.cs`](/src/Client/SkyLogg.Client.Maui/Services/MauiAppUpdateService.cs)
...
**File**: [`src/Client/SkyLogg.Client.Core/Components/Layout/ForceUpdateSnackBar.razor`](/src/Client/SkyLogg.Client.Core/Components/Layout/ForceUpdateSnackBar.razor)
...
**File**: [`src/Client/SkyLogg.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs`](/src/Client/SkyLogg.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs)

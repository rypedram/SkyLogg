...
**Location**: [`/src/Client/SkyLogg.Client.Core/Components/Pages/Products/ProductsPage.razor`](/src/Client/SkyLogg.Client.Core/Components/Pages/Products/ProductsPage.razor)
...
**Location**: [`/src/Client/SkyLogg.Client.Core/Components/Pages/Products/ProductsPage.razor.cs`](/src/Client/SkyLogg.Client.Core/Components/Pages/Products/ProductsPage.razor.cs)

This file contains the **component logic** - all C# code for the component:

```csharp
using SkyLogg.Shared.Dtos.Products;
using SkyLogg.Shared.Controllers.Products;

namespace SkyLogg.Client.Core.Components.Pages.Products;
...
**Location**: [`/src/Client/SkyLogg.Client.Core/Components/Pages/Products/ProductsPage.razor.scss`](/src/Client/SkyLogg.Client.Core/Components/Pages/Products/ProductsPage.razor.scss)
...
#### Adding to NavBar
**Location**: [`/src/Client/SkyLogg.Client.Core/Components/Layout/NavBar.razor`](/src/Client/SkyLogg.Client.Core/Components/Layout/NavBar.razor)
...
**Location**: [`/src/Client/SkyLogg.Client.Core/Components/Layout/MainLayout.razor.items.cs`](/src/Client/SkyLogg.Client.Core/Components/Layout/MainLayout.razor.items.cs)
...
Some pages need access to native platform features (e.g., device info, native APIs). Instead of placing them in `SkyLogg.Client.Core` and using dependency injection or pub-sub patterns, you can create **platform-specific pages** directly in platform projects.

#### Example: AboutPage

The `AboutPage` demonstrates this pattern by existing in multiple platform projects:
- [`/src/Client/SkyLogg.Client.Maui/Components/Pages/AboutPage.razor`](/src/Client/SkyLogg.Client.Maui/Components/Pages/AboutPage.razor)
- [`/src/Client/SkyLogg.Client.Windows/Components/Pages/AboutPage.razor`](/src/Client/SkyLogg.Client.Windows/Components/Pages/AboutPage.razor)
- [`/src/Client/SkyLogg.Client.Web/Components/Pages/AboutPage.razor`](/src/Client/SkyLogg.Client.Web/Components/Pages/AboutPage.razor)
...
**In `SkyLogg.Client.Maui.csproj`, `SkyLogg.Client.Windows.csproj`, and `SkyLogg.Client.Web.csproj`:**
...
<Target Name="BuildCssFiles">
    <Exec Command="../SkyLogg.Client.Core/node_modules/.bin/sass Components:Components" />
</Target>
```
...
**Location**: [`/src/Client/SkyLogg.Client.Core/Styles/app.scss`](/src/Client/SkyLogg.Client.Core/Styles/app.scss)
...
**Location**: [`/src/Client/SkyLogg.Client.Core/Styles/abstracts/_bit-css-variables.scss`](/src/Client/SkyLogg.Client.Core/Styles/abstracts/_bit-css-variables.scss)
...
**Location**: [`/src/Client/SkyLogg.Client.Core/Components/Pages/AppPageBase.cs`](/src/Client/SkyLogg.Client.Core/Components/Pages/AppPageBase.cs)

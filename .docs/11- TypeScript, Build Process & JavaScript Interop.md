...
### Location
[`/src/Client/SkyLogg.Client.Core/tsconfig.json`](/src/Client/SkyLogg.Client.Core/tsconfig.json)
...
```jsonc
{
    /* Note for Developers:
        ...
        of the MSBuild process defined in the SkyLogg.Client.Core.csproj file's `BuildJavaScript` target.
    */
    "compilerOptions": {
        "strict": true,
        "target": "ES2019",
...
### Location
[`/src/Client/SkyLogg.Client.Core/package.json`](/src/Client/SkyLogg.Client.Core/package.json)
...
### Location
[`/src/Client/SkyLogg.Client.Core/SkyLogg.Client.Core.csproj`](/src/Client/SkyLogg.Client.Core/SkyLogg.Client.Core.csproj)
...
**Location:** [`/src/Client/SkyLogg.Client.Core/Scripts/App.ts`](/src/Client/SkyLogg.Client.Core/Scripts/App.ts)
...
**Location:** [`/src/Client/SkyLogg.Client.Core/Infrastructure/Extensions/IJSRuntimeExtensions.cs`](/src/Client/SkyLogg.Client.Core/Infrastructure/Extensions/IJSRuntimeExtensions.cs)

This file defines C# extension methods that call the JavaScript functions in `App.ts`:

```csharp
using System.Reflection;
using SkyLogg.Shared.Dtos.PushNotification;
...
Run the following commands in the `SkyLogg.Client.Core` directory:

```powershell
cd src/Client/SkyLogg.Client.Core
npm install uuid
...
Add this import at the top and new method to the `App` class in [`Scripts/App.ts`](/src/Client/SkyLogg.Client.Core/Scripts/App.ts):
...
Add this method to [`Extensions/IJSRuntimeExtensions.cs`](/src/Client/SkyLogg.Client.Core/Extensions/IJSRuntimeExtensions.cs):
...
```powershell
cd src/Server/SkyLogg.Server.Web
dotnet build
```

...
**File**: [`src/Server/SkyLogg.Server.Api/Infrastructure/Controllers/AppControllerBase.cs`](/src/Server/SkyLogg.Server.Api/Infrastructure/Controllers/AppControllerBase.cs)

```csharp
namespace SkyLogg.Server.Api.Controllers;
...
3. **Cleaner Code**: Less skylogg, more focus on business logic.

### Example from CategoryController

**File**: [`src/Server/SkyLogg.Server.Api/Features/Categories/CategoryController.cs`](/src/Server/SkyLogg.Server.Api/Features/Categories/CategoryController.cs)
...
**File**: [`src/Client/SkyLogg.Client.Core/Infrastructure/Services/ODataQuery.cs`](/src/Client/SkyLogg.Client.Core/Infrastructure/Services/ODataQuery.cs)
...
**File**: [`src/Client/SkyLogg.Client.Core/Components/Pages/Products/ProductsPage.razor.cs`](/src/Client/SkyLogg.Client.Core/Components/Pages/Products/ProductsPage.razor.cs)
...
**File**: [`src/Server/SkyLogg.Server.Api/Features/Products/ProductController.cs`](/src/Server/SkyLogg.Server.Api/Features/Products/ProductController.cs)
...
2. Implement the interface in `SkyLogg.Server.Api/Controllers` (server-side)

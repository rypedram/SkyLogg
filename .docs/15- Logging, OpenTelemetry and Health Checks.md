...
Welcome to Stage 15! In this stage, you'll learn about the comprehensive logging, observability, and health monitoring infrastructure built into the SkyLogg project.
...
This is implemented in [`src/Server/SkyLogg.Server.Api/Infrastructure/SignalR/AppHub.cs`](/src/Server/SkyLogg.Server.Api/Infrastructure/SignalR/AppHub.cs):
...
From [`src/Server/SkyLogg.Server.Shared/Extensions/Infrastructure/WebApplicationBuilderExtensions.cs`](/src/Server/SkyLogg.Server.Shared/Infrastructure/Extensions/WebApplicationBuilderExtensions.cs):
...
When running the project with .NET Aspire (via `SkyLogg.Server.AppHost`), the dashboard is automatically available at:
...
From [`src/Server/SkyLogg.Server.Shared/Infrastructure/Extensions/WebApplicationExtensions.cs`](/src/Server/SkyLogg.Server.Shared/Infrastructure/Extensions/WebApplicationExtensions.cs):
...
From [`src/Server/SkyLogg.Server.Shared/Infrastructure/Extensions/WebApplicationBuilderExtensions.cs`](/src/Server/SkyLogg.Server.Shared/Infrastructure/Extensions/WebApplicationBuilderExtensions.cs):
...
The project includes a custom health check for storage in [`src/Server/SkyLogg.Server.Api/Infrastructure/Services/AppStorageHealthCheck.cs`](/src/Server/SkyLogg.Server.Api/Infrastructure/Services/AppStorageHealthCheck.cs):

...
Welcome to Stage 6! In this stage, you will learn about the comprehensive exception handling and error management system built into the SkyLogg project.
...
From [`src/Server/SkyLogg.Server.Api/Features/Identity/IdentityController.EmailConfirmation.cs`](/src/Server/SkyLogg.Server.Api/Features/Identity/IdentityController.EmailConfirmation.cs):
...
**Location:** [`src/Server/SkyLogg.Server.Api/Infrastructure/Extensions/KnownExceptionExtensions.cs`](/src/Server/SkyLogg.Server.Api/Infrastructure/Extensions/KnownExceptionExtensions.cs)
...
```json
{
  "type": "SkyLogg.Shared.Exceptions.TooManyRequestsException",
...
From [`src/Server/SkyLogg.Server.Api/Features/Identity/IdentityController.cs`](/src/Server/SkyLogg.Server.Api/Features/Identity/IdentityController.cs):
...
From [`src/Client/SkyLogg.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs`](/src/Client/SkyLogg.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs):
...
**Location:** [`src/Client/SkyLogg.Client.Core/Components/AppComponentBase.cs`](/src/Client/SkyLogg.Client.Core/Components/AppComponentBase.cs)
...
From [`src/Client/SkyLogg.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor`](/src/Client/SkyLogg.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor):
...
**Handled by:** `BitMessageBoxService` in [`ClientExceptionHandlerBase`](/src/Client/SkyLogg.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Handled by:** `SnackBarService` in [`ClientExceptionHandlerBase`](/src/Client/SkyLogg.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/SkyLogg.Client.Core/Components/AppErrorBoundary.razor`](/src/Client/SkyLogg.Client.Core/Components/AppErrorBoundary.razor)
...
**Location:** [`src/Server/SkyLogg.Server.Api/Infrastructure/Services/ServerExceptionHandler.cs`](/src/Server/SkyLogg.Server.Api/Infrastructure/Services/ServerExceptionHandler.cs)
...
```json
{
  "type": "SkyLogg.Shared.Exceptions.ResourceNotFoundException",
...
**Location:** [`src/Client/SkyLogg.Client.Core/Services/ClientExceptionHandlerBase.cs`](/src/Client/SkyLogg.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/SkyLogg.Client.Web/Services/WebClientExceptionHandler.cs`](/src/Client/SkyLogg.Client.Web/Services/WebClientExceptionHandler.cs)
...
**Location:** [`src/Client/SkyLogg.Client.Maui/Services/MauiExceptionHandler.cs`](/src/Client/SkyLogg.Client.Maui/Services/MauiExceptionHandler.cs)
...
**Location:** [`src/Client/SkyLogg.Client.Windows/Services/WindowsExceptionHandler.cs`](/src/Client/SkyLogg.Client.Windows/Services/WindowsExceptionHandler.cs)
